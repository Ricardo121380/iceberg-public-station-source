...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.RouteTag("relay"), middleware.AnomalyObservation())
	playgroundRouter.Use(middleware.SystemPerformanceCheck())
	playgroundRouter.Use(middleware.UserAuth(), middleware.StreamingOnly(), middleware.Distribute())
	{
		playgroundRouter.POST("/chat/completions", controller.Playground)
	}
	relayV1Router := router.Group("/v1")
	relayV1Router.Use(middleware.RouteTag("relay"), middleware.AnomalyObservation())
	relayV1Router.Use(middleware.SystemPerformanceCheck())
	relayV1Router.Use(middleware.TokenAuth())
	relayV1Router.Use(middleware.StreamingOnly())
	...
	relayGeminiRouter.Use(middleware.StreamingOnly())
