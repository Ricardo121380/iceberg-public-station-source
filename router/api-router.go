...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/oauth/:provider", middleware.OAuthCallbackRateLimit(), middleware.DisableCache(), middleware.TryUserAuth(), controller.HandleOAuth)
		...
		dataRoute.GET("/quality", middleware.AdminAuth(), controller.GetUsageQuality)
		dataRoute.GET("/quality/self", middleware.UserAuth(), controller.GetUsageQuality)
...
func registerAbuseRoutes(apiRouter *gin.RouterGroup) {
	...
	abuseRouter.POST("/events/:id/excerpt", middleware.SessionCookieOriginGuard(), middleware.UserCriticalRateLimit("abuse-excerpt"), controller.ReadAbuseEvidence)
	abuseRouter.POST("/events/:id/review", middleware.SessionCookieOriginGuard(), middleware.UserCriticalRateLimit("abuse-review"), controller.SaveAbuseReview)
	abuseRouter.GET("/events/:id/history", controller.GetAbuseReviewHistory)
