...
export function Rankings() {
  ...
  return (
    <PublicLayout showFooter showMainContainer={false}>
        ...
        <div
          ...
          style={{
            background: [
              ...
              'radial-gradient(ellipse 50% 40% at 80% 15%, color-mix(in oklch, var(--station-glow) 90%, transparent) 0%, transparent 70%)',
              'radial-gradient(ellipse 40% 35% at 50% 70%, color-mix(in oklch, var(--chart-5) 45%, transparent) 0%, transparent 70%)',
            ].join(', '),
            maskImage:
